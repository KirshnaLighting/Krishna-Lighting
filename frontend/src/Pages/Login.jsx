...
const LoginForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://krishna-lighting-backend.onrender.com/api/auth/login', {
        method: 'POST',
        headers: {
      ...
      localStorage.setItem('krishnaLightingToken', data.token);
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center px-4 py-10 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Access premium lighting solutions and your order history
          </p>
        </div>
